...
description: "[{{< ai doi size=xl >}}](https://proceedings.neurips.cc/paper/2019/hash/d464b5ac99e74462f321c06ccacc4bff-Abstract.html) [{{< bi file-pdf size=1.5em >}}](https://proceedings.neurips.cc/paper/2019/file/d464b5ac99e74462f321c06ccacc4bff-Paper.pdf) [{{< bi github size=1.5em >}}](https://github.com/DavidSabbagh/meeg_power_regression)"
author: "Sabbagh, David, Pierre Ablin, Gaël Varoquaux, Alexandre Gramfort, and Denis A. Engemann."
date: 12/10/2019
draft: false
max-description-length: 2000
categories: [paper, published, NeurIPS, neuroscience, M/EEG, machine learning, brain age, Riemannian geometry, spatial filtering]
---

## Statistically consistent regression modeling from brain activity recoreded with M/EEG

![](../sabbagh_2019_neurips.png)
